...
public class UTorontoChess extends JFrame {

    public UTorontoChess() {
        super("UTorontoChess");//shows title in the frame
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//closes on exit

        UTorontoChessPanel game = new UTorontoChessPanel();//creates a new panel in the frame
    ...
    public static void main(String[] arguments) {
        ...
        board.movePiece(start, end);
        System.out.println(board);
        UTorontoChess frame = new UTorontoChess();
    }
}

class UTorontoChessPanel extends JPanel implements KeyListener, ActionListener, MouseListener {
